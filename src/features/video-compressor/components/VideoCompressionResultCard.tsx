...
import { VideoCompressionResult } from '../../../types';
import { formatBytes } from '../../../lib/file-utils';
import { formatBitrate } from '../../../lib/media-utils';

interface VideoCompressionResultCardProps {
  result: VideoCompressionResult;
  originalSize: number;
  onDownload: () => void;
}

export const VideoCompressionResultCard: React.FC<VideoCompressionResultCardProps> = ({
  result,
  originalSize,
  onDownload,
}) => {
